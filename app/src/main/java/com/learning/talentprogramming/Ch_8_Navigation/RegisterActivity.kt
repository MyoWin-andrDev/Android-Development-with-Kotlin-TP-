...
import com.learning.talentprogramming.databinding.ActivityRegisterCh9Binding

class RegisterActivity : AppCompatActivity() {
    private lateinit var binding : ActivityRegisterCh9Binding
    private var etName = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRegisterCh9Binding.inflate(layoutInflater)
